...
Historique détaillé, déplacé de `ARCHITECTURE.md` et de `DECISIONS.md` (septembre 2026). Ordre antichronologique. Ce fichier n'est lu que sur demande explicite ; les décisions encore en vigueur sont résumées dans `DECISIONS.md`.

---

# Notes techniques par version (ex-`ARCHITECTURE.md`)
...
# Chantier Programmes — détails par étape (ex-`DECISIONS.md`)

Les règles du générateur, l'architecture retenue et les sports couverts restent dans `DECISIONS.md` ; ci-dessous, les arbitrages détaillés de chaque étape.
